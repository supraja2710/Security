        ...
        success: function(response) {
            ...
            if (data.length > 0) {
                ...
                for ( var i = 0; i < lenSuperuserData; i++ ) {
                    $("#superusersTbody").append("<tr><td>" + listSuperusers[i] + "</td><td><input id=" + listSuperusers[i] + " type='submit'  value='Remove' class='btn-small red waves-effect waves-light btn' data-toggle='tooltip' title='Remove this Lymphocyte App Superuser'></td></tr>");
                }
